% fine grained clustering fast function
function [class,type]=fine_grained_clustering_fast_func(input_file, folder_out)
tic;
% input_file: path to a coarse-grain-index typed file
% folder_out: path to the output directory
%input_file = '../data/clusters/coarse_typed/coarse-grain-indexes-14_typed';
