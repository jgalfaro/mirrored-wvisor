...
# Parse args
if len(sys.argv) != 6:
	print "Usage: %s <dimensions> <feature_vectors> <cluster_indexes> <urls> <mds>" % sys.argv[0]
	...
	print "  mds: Output file that contains coords and image data."
	exit(0)
else:
...
print 'MDS...'
mds = manifold.MDS(n_components=dimensions, n_jobs=-1)
